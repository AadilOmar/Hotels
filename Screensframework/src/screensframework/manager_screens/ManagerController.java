...
public class ManagerController implements Initializable, ControlledScreen {
    ...
    private boolean already_created_all_reservation_table = false;
    ...
    private void view_reservation_report (ActionEvent event){
        ...
        String augQuery = "SELECT Hotel_Location, COUNT( Reservation_ID) FROM `RESERVED` WHERE Start_Date >= 2015-08-01 and Start_Date <= 2015-08-31 GROUP BY Hotel_Location";
        String septQuery = "SELECT Hotel_Location, COUNT( Reservation_ID) FROM `RESERVED` WHERE Start_Date >= 2015-09-01 and Start_Date <= 2015-09-30 GROUP BY Hotel_Location";
        ...
        try {
            ...
            preparedStatement2 = connection.prepareStatement(septQuery);
            septResultSet = preparedStatement2.executeQuery();
        ...
        if (!already_created_all_reservation_table) {
            create_reservation_report_table(all_reservations_table);
            already_created_all_reservation_table = true;
        }
